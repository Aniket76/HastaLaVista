...
import com.aniketvishal.hastalavista.Data.Cat1Data;
...
public class IntroFragment extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mRecyclerView = (RecyclerView)getActivity().findViewById(R.id.cat1_rv);
        mRecyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        mRecyclerView.setHasFixedSize(true);

        mAdapter = new MainCategoryAdapter(Cat1Data.getCategoryData(),getContext(), fragment);
        ...
        mShare = (LinearLayout) getActivity().findViewById(R.id.cat1_image1);
        mRateUs = (LinearLayout) getActivity().findViewById(R.id.cat1_image2);
        mMoreApps = (LinearLayout)getActivity().findViewById(R.id.cat1_image);
