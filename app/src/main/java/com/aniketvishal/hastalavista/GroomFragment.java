...
import com.aniketvishal.hastalavista.Data.Cat3Data;
...
public class GroomFragment extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mRecyclerView = (RecyclerView)getActivity().findViewById(R.id.cat3_rv);
        mRecyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        mRecyclerView.setHasFixedSize(true);

        mAdapter = new MainCategoryAdapter(Cat3Data.getCategoryData(),getContext(), fragment);
        ...
        mShare = (LinearLayout) getActivity().findViewById(R.id.cat3_image1);
        mRateUs = (LinearLayout) getActivity().findViewById(R.id.cat3_image2);
        mMoreApps = (LinearLayout)getActivity().findViewById(R.id.cat3_image);
